      ...
      {(isLoading) ? <Loader /> :
        <div className="about-us-container" >
          ...
          <div className="faq-container">
            <p className="faq-question"><strong>1. How do I create a quiz?</strong></p>
            ...
            <p className="faq-question"><strong>2. Can I track my quiz performance?</strong></p>
            ...
            <p className="faq-question"><strong>3. Is there a limit to the number of quizzes I can create?</strong></p>
            ...
            <p className="faq-question"><strong>4. How do I reset my password?</strong></p>
            <p>If you've forgotten your password, go to the "Profile" page and click "Update Password."</p>

            <p className="faq-question"><strong>5. Can I collaborate with others on quizzes?</strong></p>
            ...
            <p className="faq-question"><strong>6. How do I report a bug or request a feature?</strong></p>
