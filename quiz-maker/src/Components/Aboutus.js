            ...
            <ul className="accordion mx-auto max-w-3xl">
              {FAQ_DATA.map((item, index) => (
                <li className="my-2" key={index}>
                  <div
                    className="flex items-center justify-between w-full p-5 bg-gray-700 text-lg font-semibold cursor-pointer transition duration-200 ease-in-out hover:bg-[#5a6065]"
