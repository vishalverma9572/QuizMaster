...
import img from "../images/team.svg"; // Ensure this is your appropriate image
...
const StyledTypography = styled(Typography)(() => ({
  marginBottom: "30px",
  fontFamily: "Lora, serif", // Updated font style
  color: "#235",
...
const AboutUs = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setIsLoading(false);
    }, 500); // Reduce loader time for better user experience
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col about-us-container">
          ...
          >
            ...
            >
              <img className="w-[100%] h-[100%]" src={img} alt="team" />
            </div>
            <div
              className={`${
                window.width <= 820 ? "w-[99%]" : "w-[40%]"
              } flex h-[92vh] gap-[30px] flex-col items-center justify-center text-black`}
            >
              <TypeIt className="text-cyan-500 text-5xl font-extrabold font-sans">
                About Us
              </TypeIt>
              <div className="forScroll p-[10px] bg-cyan-100 rounded-lg text-center w-[90%] h-[50%] overflow-scroll font-semibold font-sans text-gray-700 text-xl">
              ...
              <a
                className="w-[100px] h-[40px] flex items-center justify-center bg-blue-700 rounded-md text-white text-center font-medium smooth-scroll button-shadow"
                href="#faq"
              >
                FAQs
              </a>
          ...
          <div className="faq-search-container" style={{ textAlign: "center", marginBottom: "20px" }}>
            <h2 id="faq" className="text-black text-4xl font-bold font-sans mb-[80px] mt-[50px]">
              ...
              {filteredFaqs.length > 0 ? (
                filteredFaqs.map((faq, index) => (
                  <li key={index}>
                    ...
                    <label htmlFor={`faq-${index}`} data-text={faq.question}>
                      {faq.question}
                    </label>
