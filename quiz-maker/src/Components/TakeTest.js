      ...
      <div className="take-test">
        ...
        <div className="content-wrapper">
          ...
          <div className="instructions-section">
            ...
            <p>
              The Quiz ID is a unique identifier for each quiz. It can be found
              in the quiz details or provided by the quiz creator.
            </p>
            <p>
              Or You can Directly access the Quiz by the link provided by quiz
              Creator.
            </p>
          ...
          <div className="quiz-details-section">
            ...
            <div className="quiz-card">
              ...
              <p>
                ...
                {new Date(quizDetails.lastUpdated).toLocaleDateString()}
              </p>
              <p>
                <strong>Owner:</strong> {quizDetails.createdBy}
              </p>
              <p>
                <strong>Participants:</strong> {quizDetails.takenBy}
              </p>
              <p>
                <strong>Time Limit:</strong> {quizDetails.timeLimit} minutes
              </p>
              <p>
                <strong>Number of Questions:</strong> {quizDetails.questions}
              </p>
              <button
                className="button"
