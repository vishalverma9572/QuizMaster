    ...
    <StyledCard>
      <StyledCardContent>
        ...
        <div className="buttons_container">
          <StyledButton variant="contained" onClick={onDetailsClick}>
            Details &nbsp; <iconify-icon icon="gg:details-more"></iconify-icon>{" "}
          </StyledButton>
          <StyledButton variant="contained" onClick={shareQuiz}>
            Share &nbsp;
...
function getOrdinalSuffix(day) {
  ...
  return day < 10 || day > 20
    ? suffixes[
        remainder === 1 ? 0 : remainder === 2 ? 1 : remainder === 3 ? 2 : 3
      ]
    : suffixes[3];
}
